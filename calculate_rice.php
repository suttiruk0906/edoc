...
<head>
    ...
    <style>
        ...
        table {
            ...
            margin-bottom: 16px;
            background-color: rgb(124, 236, 150);
        }
        ...
        th {
            background-color:rgb(130, 164, 27);
            color: white;
            font-size: 16px;
        }
...
<body>
    ...
    <form action="process_rice.php" method="post">
        
    <h2><i class="fas fa-calculator"></i> คำนวณราคาขายข้าวสาร</h2>
