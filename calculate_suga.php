...
<head>
    <meta charset="UTF-8">
    <title>คำนวณราคาขายน้ำตาล</title>
    ...
    <style>
        ...
        table {
            ...
            margin-bottom: 16px;
            background-color: rgb(246, 190, 226);
        }
        ...
        th {
            background-color:rgb(164, 27, 137);
            color: white;
            font-size: 16px;
        }
...
<body>
    ...
    <form action="process_suga.php" method="post">
        
    <h2><i class="fas fa-calculator"></i> คำนวณราคาขายน้ำตาล</h2>
