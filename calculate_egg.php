...
<head>
    <meta charset="UTF-8">
    <title>คำนวณราคาขายไข่ไก่</title>
    ...
    <style>
        ...
        table {
            ...
            margin-bottom: 16px;
            background-color: rgb(246, 242, 169);
        }
        ...
        th {
            background-color:rgb(194, 188, 153);
            color: white;
            font-size: 16px;
        }
...
<body>
    ...
    <form action="process_egg.php" method="post">
        
    <h2><i class="fas fa-calculator"></i> คำนวณราคาขายไข่ไก่</h2>
