...
<head>
    ...
    <style>
        ...
        table {
            ...
            margin-bottom: 16px;
            background-color: rgb(251, 216, 145);
        }
        ...
        th {
            background-color:rgb(180, 79, 35);
            color: white;
            font-size: 16px;
        }
...
<body>
    ...
    <form action="process_fertilizer.php" method="post">
        
    <h2><i class="fas fa-calculator"></i> คำนวณราคาขายปุ๋ย</h2>
